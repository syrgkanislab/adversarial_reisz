...
This mini-guide contains instructions for using either virtualenv or mamba to set up a virtual environment. Use whichever is more convenient, which may depend on what comes pre-installed on your HPC cluster. Credit: William Liu and Martin Lob.
